...
class FeaturesUpsamplingLayerTest(VL3DTest):
    ...
    def run(self):
        ...
        fdl_exp = FeaturesUpsamplingLayer(filter='exponential')
        ...
        valid = valid and self.validate_exponential_upsampling(
    ...
    def validate_exponential_upsampling(
        self, inputs, nneighs, fdl_exp_out
    ):
        """
        Check whether the exponential-based upsampling layer yielded the
        expected output (True) or not (False).
