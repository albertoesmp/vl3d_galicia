...
-- Brief: SQL query to compute the class-wise evaluation of the terrain, water,
--          building, and vegetation by height experiments.
--          The class-wise evaluation considers all the 
--          predicted point clouds for the fullraw classification task.
