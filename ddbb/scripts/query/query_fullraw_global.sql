...
-- Brief: SQL query to compute the global evaluation of the ground, water, 
--          building, and vegetation by height experiments. The global
--          evaluation considers all the predicted point clouds for the
--          building and vegetation classification task.
