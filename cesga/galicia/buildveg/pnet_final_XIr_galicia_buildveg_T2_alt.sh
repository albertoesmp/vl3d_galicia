...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_XIr_buildveg_training_T2_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_XIr_buildveg_predict_T2_alt.json'
