...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_X_buildveg_training_T1_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_X_buildveg_predict_T1_alt.json'
