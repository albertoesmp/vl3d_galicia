...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_XIrRGB_buildveg_training_T4_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/buildveg/pnet_final_XIrRGB_buildveg_predict_T4_alt.json'
