...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnet_final_XIr_building_training_T1_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnet_final_XIr_building_predict_T1_alt.json'
