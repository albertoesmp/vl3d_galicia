...
# ---  VARIABLES  --- #
# ------------------- #
TRAINING_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnet_final_XRGB_building_training_T4_alt.json'
PREDICTIVE_SPEC='/home/usc/ci/aep/git/virtualearn3d/cesga/galicia/building/pnet_final_XRGB_building_predict_T4_alt.json'
